...
type AdminOrder = {
	...
	payment_reference: string; status: string; quote_status: string; whatsapp_consent: number; total_amount: number; deposit_amount: number;
...
const BUSINESS_WHATSAPP = "263776819271"; // Official Meta WhatsApp Business/API number.
const BACKUP_WHATSAPP = "263773835075"; // Second WhatsApp Business support line.
const STATUS = {
...
function customerStatusMessage(order: AdminOrder) {
	const messages: Record<string, string> = {
		"Awaiting price verification": "We are verifying the live SHEIN price for your requested products.",
		"Awaiting customer quote acceptance": "Your final quote is ready. Please check your private tracking link and accept the quote.",
		"Awaiting deposit": "Your final quote was accepted. Please pay the required deposit and send your payment reference.",
		"Awaiting deposit verification": "We received your deposit payment reference and are verifying it.",
		Placed: "Your payment was verified. LELE Runner has placed your order.",
		Purchased: "Your items have been purchased from the supplier.",
		Shipped: "Your order has been shipped and is on its way.",
		Customs: "Your order is in the customs process.",
		"Out for delivery": "Your parcel is out for delivery.",
		Delivered: "Thank you for using LELE Runner. Your order was successfully delivered.",
		Cancelled: "Your order was cancelled. Please contact LELE Runner if you need help.",
		"Refund pending": "Your refund is being processed.",
		Refunded: "Your refund has been completed. Thank you for your patience.",
	};
	return `LELE RunnerZW update\n\nOrder: ${order.order_code}\nStatus: ${order.status}\n\n${messages[order.status] || "Your order status has been updated."}`;
}

function manualWhatsAppLink(order: AdminOrder) {
	return `https://wa.me/${normalizeWhatsApp(order.customer_phone)}?text=${encodeURIComponent(customerStatusMessage(order))}`;
}
